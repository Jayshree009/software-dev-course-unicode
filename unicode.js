...
let firstChar = inputString2.charAt(0); // 'L'
let lastChar = inputString2.charAt(inputString2.length - 1); // 'h'
let middlePart = inputString2.slice(1, -1); // "aunc"
let swappedString = lastChar + middlePart + firstChar; // "hauncL"
